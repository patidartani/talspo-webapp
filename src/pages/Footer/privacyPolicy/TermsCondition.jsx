      ...
      <Container>
        <div className="terms-container">
          ...
          <p>
            ...
            Standard Terms and Conditions. People below 13 years old are not
            allowed to use this Website
          </p>
          <h4>Intellectual Property Rights</h4>
          <p>
            Other than the content you own, under these Terms, Talspo Private
            Limited and/or its licensors own all the intellectual property
          ...
          <p>
            ...
            you and Talspo Private Limited may further restrict access by you to
          ...
          <p>
            ...
            Talspo Private Limited a non-exclusive, worldwide irrevocable, sub
            ...
            and must not be invading any third-party’s rights. Talspo Private
            Limited reserves the right to remove any of Your Content from this
            Website at any time without notice.
          </p>
          <h4>No warranties</h4>
          <p>
            This Website is provided “as is,” with all faults, and Talspo
            Private Limited express no representations or warranties, of any
          ...
          <p>
            In no event shall Talspo Private Limited, nor any of its officers,
            ...
            such liability is under contract. Talspo Private Limited, including
          ...
          <p>
            You hereby indemnify to the fullest extent Talspo Private Limited
          ...
          <p>
            Talspo Private Limited is permitted to revise these Terms at any
            time as it sees fit, and by using this Website you are expected to
            review these Terms on a regular basis
          </p>
          <h4>Assignment</h4>
          <p>
            The Talspo Private Limited is allowed to assign, transfer, and
          ...
          <p>
            These Terms constitute the entire agreement between Talspo Private
            Limited and you in relation to your use of this Website, and
            supersede all prior agreements and understandings.
          </p>
          <h4> Governing Law & Jurisdiction</h4>
          <p>
            These Terms will be governed by and interpreted in accordance with
            the laws of the State of Madhya Pradesh, India, and you submit to
            the non-exclusive jurisdiction of the state and federal courts
            located in Madhya Pradesh, India for the resolution of any disputes.
          </p>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Talspo Private Limited, Ocean Park
                Township, Indore Bypass Road, near Delhi Public School Indore,
                Nipania, Indore, Madhya Pradesh 452016.
              </p>
            </li>
            <li>
              <p>
