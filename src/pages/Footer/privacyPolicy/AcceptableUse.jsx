...
const AcceptableUse = () => {
  return (
    ...
    <div className="anti-spam-policy">
      ...
      Conditions (’Legal Terms’) and should therefore be read alongside our main Legal Terms: <a href="https://taispo.com/terms-and-conditions" target="_blank" rel="noopener noreferrer">When you use the Al-powered services provided by Talspo Private Limited ('AI Products’), you warrant that you will comply with this document, our Legal Terms and all applicable laws and regulations governing AI. Your usage of our AI Products signifies your agreement to engage with our platform in a lawful, ethical, and responsible manner that respects the rights and dignity of all individuals. If you do not agree with these Legal Terms, please refrain from using our Services. Your continued use of our Services implies acceptance of these Legal Terms.
        </a>.
      </p>
    <p>Please carefully review this Policy which applies to any and all:</p>
    <ul>
        <li>
          <strong>(a)</strong> uses of our Services (as defined in ‘Legal Terms’)
        </li>
        <li>
          <strong>(b)</strong> forms, materials, consent tools, comments, posts, and all other content 
          available on the Services (‘Content’)
        </li>
        <li>
          <strong>(c)</strong> material which you contribute to the Services, including any upload, 
          post, review, disclosure, ratings, comments, chat, etc., in any forum, chatrooms, reviews, 
          and to any interactive services associated with it (‘Contribution’)
        </li>
        <li>
          <strong>(d)</strong> responsible implementation and management of AI Products within our Services
        </li>
      </ul>
      <h4>WHO WE ARE</h4>
      <p> 
        We are Talspo Private Limited, doing business as TS ('Company’, ’we’, ’us', or ’our’), a company 
        registered in India at Ocean Park Township, Indore Bypass Road, near Delhi Public School Indore, 
        Nipania, Indore, Madhya Pradesh 452016. We operate the website 
        <a href="https://taispo.com" target="_blank" rel="noopener noreferrer">
          https://taispo.com
        </a> 
        (the ’Site’), the mobile application Talspo (the 'App'), as well as any other related products and 
...
<ul><li>Systematically retrieve data or other content from the Services to create or compile, directly or indirectly, a collection, compilation, database, or directory without written permission from us.</li>
...
<ul>
    <li>Engage in any use, including modification, copying, redistribution, publication, display, performance, or retransmission, of any portions of any Services, other than as expressly permitted by this Policy, without the

prior written consent of Talspo Private Limited, which consent Talspo Private Limited may grant or refuse in its sole and absolute discretion.</li>
...
<h4>AI Products</h4>
<p>When you use the AI Products provided by Talspo Private Limited, you warrant that you will not:</p>
<ul><li>Deploy AI techniques that utilise subliminal, manipulative, or deceptive methods designed to
distort behaviour and impair informed decision-making, particularly when such actions cause significant harm to individuals.</li>
...
<li>Implement Al-based social scoring systems that evaluate or classify individuals or groups based on their social behaviour or personal traits in a manner that causes harm, discrimination, or unfair treatment.</li>
...
<p>We recognise the significant impact AI can have on our users and society, and we are dedicated to ensuring that our AI Products are designed and operated in a manner that aligns with comprehensive ethical standards. We aim to use AI to enhance user experiences while upholding fairness, transparency, and accountability principles.</p>
<p>This Policy applies to all Al-powered features, services, and systems in our Services. It governs the development, deployment, and use of AI technologies to protect users’ rights and maintain transparency in all AI operations. This Policy applies to all stakeholders, including employees, third-party vendors, and partners who contribute to or interact with our AI Products.</p>
<h4>Enforcement</h4>
<p>Any misuse of our AI Products or failure to adhere to the standards outlined in this Policy will result in appropriate actions to ensure the integrity of our platform and the protection of our users. The specific consequences for misuse of AI may vary depending on the nature and severity of the violation and the user’s history with our Services.</p>
...
<ul>
    ...
    <p>Depending on the violation, Talspo Private Limited may take one or more of the following actions:</p>
...
<p>At Talspo Private Limited, we are committed to the ongoing refinement and enhancement of our Policy. As technology evolves and regulatory environments shift, we recognise the importance of keeping our policies up to date to ensure that they remain relevant, effective, and aligned with best practices in AI ethics. We will regularly review and update our Policy to reflect technological advancements and legal changes in local, national, and international regulations related to AI. Our Policy will be updated as needed to comply with new laws and guidelines, ensuring that our practices remain legally sound and socially responsible.</p>
      ...
      <ul>
        ...
        <li>any other content, materials, or data you provide to Talspo Private Limited or use with the Services.</li>
      </ul>
      <p>Some areas of the Services may allow users to upload, transmit, or post Contributions. We may but are under no obligation to review or moderate the Contributions made on the Services, and we expressly exclude our liability for any loss or damage resulting from any of our users’ breach of this Policy. Please report any Contribution that you believe breaches this Policy; however, we will determine, in our sole discretion, whether a Contribution is indeed in breach of this Policy.</p>
      <h5>You warrant that:</h5>
      <ul><li>you are the creator and owner of or have the necessary licences, rights, consents, releases, and permissions to use and to authorise us, the Services, and other users of the Services to use your Contributions in any manner contemplated by the Services and this Policy;</li>
      ...
      <li>you have the verifiable consent, release, and/or permission of each and every identifiable individual person in your Contributions to use the name or likeness of each and every such identifiable individual person to enable inclusion and use of your Contributions in any manner contemplated by the Services and this Policy.</li></ul>
      ...
      <li>is discriminatory based on race, sex, religion, nationality, disability, sexual orientation, or age;
      •bullies, intimidates, humiliates, or insults any person;</li>
      <li>promotes, facilitates, or assists anyone in promoting and facilitating acts of terrorism;</li>
      <li>infringes, or assists anyone in infringing, a third party’s intellectual property rights or publicity or privacy rights;
      •is deceitful, misrepresents your identity or affiliation with any person and/or misleads anyone as to your relationship with us or implies that the Contribution was made by someone else than you;</li>
      ...
      <li>cigarettes</li>
      <li>controlled substances and/or other products that present a risk to consumer safety, narcotics, steroids, drug paraphernalia,</li>
...
<li>any transaction or activity that requires pre-approval without having obtained said approval.</li>
      ...
      <ul><li>you have firsthand experience with the services and software being reviewed;</li>
      <li>your Contribution is true to your experience;</li>
      <li>you are not affiliated with competitors if posting negative reviews (or linked in any way to, e.g., by being the owner or seller/manufacturer of, a product or service if posting positive reviews);</li>
      ...
      <li>you do not and will not organise a campaign encouraging others to post reviews, whether positive or negative.</li>
      </ul>
      <h4>REPORTING A BREACH OF THIS POLICY</h4>
      <p>We may but are under no obligation to review or moderate the Contributions made on the Services and we expressly exclude our liability for any loss or damage resulting from any of our users’ breach of this Policy.</p>
